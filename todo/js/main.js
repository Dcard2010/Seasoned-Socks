...
document.getElementById('item').addEventListener('keydown', function (e) {
    // Log the keycode interpreted by Javascript
    //console.log(e.code);
    
    var value = this.value;
    if (e.code === 'Enter' && value) {
        // Log the what is typed in the textbox when Enter is pressed
        // Or log value when Enter is pressed
        //console.log(value);
...
function renderTodoList () {
    //If they are empty return nothing
...
// This runs any time there is any update to the todo item object
...
function addItemToDOM(text, completed) {
    // If completed dot he completed. If not default back to todo
    var list = (completed) ? document.getElementById('completed'):document.getElementById('todo');
    var item = document.createElement('li');
    
    // Inner text escapes the text so it is rendered as text not HTML
    item.innerText = text;
    ...
    // Add click event for adding or completing the item
