...
<style type="text/css">
	...
	#bottom-pic {
		border: solid;
		margin-top: 2%;
		background: url(img/crumpled-note-crop.png);
	}
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
				...
				<div class="left-half-container">
					<div class="left-half">
						<div id="top-pics-left">
							<a href="img/sock-note.jpg"><img src="img/sock-note.jpg"></a>
						</div>
						<div id="top-pics-right">
							<a href="seasoned-sock.jpg"><img src="img/seasoned-sock.jpg"></a>
						</div>
						<div class="break"></div>
						<div id="bottom-pic">
							<a href="img/crumpled-not-crop.png"><img src="img/crumpled-not-crop.png"></a>
						</div>
					</div>
				</div>
								...
								<ol style="padding-left: 5%">
									...
									<form method="post" id="form-validate" target="garbage">
										<fieldset>
											...
											<li>We'll write the note, stuff it in a seasoned sock, and mail to whoever you want in the US</li>
								</ol>
							</div>
							<div id="divNote">
								...
								<div id="message" class="hide">
									<p>If you don't click Save your note will not be saved!</p>
								</div>
								<div id="message-saved" class="hide">
									<p>Note Saved</p>
								</div>
		...
		<script type="text/javascript">
			...
			$("#note-contents").keypress(function() {
				...
				$("#message-saved").addClass("hide");
			})

			$("#button-add-to-cart").click(function() {
				$("#continue").removeClass("hide");
				$("#message").addClass("hide");
				$("#message-saved").removeClass("hide");
			})
